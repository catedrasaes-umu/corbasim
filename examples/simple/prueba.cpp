...
int main(int argc, char **argv)
{
    ...
    {
        SimpleExample::Abuelo ab2;
        std::string str("{\"tt\":\"IOR:\"}");

        res = corbasim::json::parse(ab2, str);
        corbasim::json::write(std::cout, ab2); 
        std::cout << std::endl << std::endl << std::endl;
