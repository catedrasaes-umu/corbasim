...
operation_factory_base const * factory_base::get_factory_by_index(
        unsigned int idx) const
{
    return m_factories[idx];
}

operation_factory_base const * factory_base::get_factory_by_name(
...
operation_factory_base const * factory_base::get_factory_by_tag(
        tag_t tag) const
{
